...
After installing the plugin on your Minecraft server, do /play to start the mini-game. Stay tuned for the target item announced at the beginning of the game and when all the state.players are ready with the /ready command, be the first to obtain it to win.
